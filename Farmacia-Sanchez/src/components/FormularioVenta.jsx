...
const FormularioVenta = () => {
    ...
    const handleSubmit = (event) => {
        ...
        const venta = {
            ...
            fabricante: parseFloat(fabricante)
        };
    ...
    const iniciarEdicion = (venta) => {
        ...
        setFabricante(venta.fabricante);
    };
    ...
    return (
        ...
        {modoEdicion ? (
            <form className="w3-container w3-card-4 w3-blue w3-text-White w3-margin" onSubmit={handleSubmit}>
            ...
            <form className="w3-container w3-card-4 w3-grey w3-text-White w3-margin" onSubmit={handleSubmit}>
                <label htmlFor="nombre">Nombre:</label>
                <input
                    type="text"
                    id="nombre"
